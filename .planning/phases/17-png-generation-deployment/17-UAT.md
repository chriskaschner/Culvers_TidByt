...
number: 1
name: 94 Hero cone PNGs exist
expected: |
  In docs/assets/cones/, there should be exactly 94 PNG files — one per entry in FLAVOR_PROFILES. Run: ls docs/assets/cones/*.png | wc -l and confirm the output is 94.
